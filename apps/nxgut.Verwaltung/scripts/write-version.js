// This script copies the version from project.json to dist/apps/nxgut.Verwaltung/version.json after build
const fs = require('fs');
const path = require('path');

const projectJsonPath = path.resolve(__dirname, '../project.json');
const distPath = path.resolve(__dirname, '../../../dist/apps/nxgut.Verwaltung');
